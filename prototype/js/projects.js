...
export const projects = [
  ...
  {
    title: 'OctoThink', meta: '2D Brain Training / Educational', image: IMG + 'octothink.png',
    links: [{ label: 'Play Store', url: 'https://play.google.com/store/apps/details?id=com.absolutelydigital.octothink&hl=en' }],
  },
  {
    title: 'Gravity Bottle Flip', meta: '2D Casual Platformer / Physics', image: IMG + 'gravity_bottle_flip.png',
    links: [
  ...
  {
    title: 'ASMR Hospital Doctor', meta: '2D Idle / Simulation', image: IMG + 'asmr_hospital_doctor.png',
    links: [
  ...
  {
    title: 'Dentist Inc.', meta: '3D Hyper Casual', image: IMG + 'dentist_inc.png',
    links: [
  ...
  {
    title: 'Surgery Doctor Simulator', meta: '2D Idle / Simulation', image: IMG + 'surgery_doctor_simulator.png',
  ...
  {
    title: 'Perfect Smash Inc.', meta: '3D Hyper Casual', image: IMG + 'perfect_smash_inc.png',
  ...
  {
    title: 'Ray Of Hope', meta: '3D Hyper Casual', image: IMG + 'ray_of_hope.png',
    links: [{ label: 'YouTube demo', url: 'https://www.youtube.com/watch?v=rOxSa7hD_8o' }],
  },
  {
    title: 'Extreme Traffic Police Bike', meta: '3D Racing', image: IMG + 'extreme_traffic_police_bike.png',
    links: [{ label: 'App Store', url: 'https://apps.apple.com/us/app/extreme-traffic-police-bike/id1117836268' }],
  },
  {
    title: 'Miners.IO', meta: '2D Idle / Top Down', image: IMG + 'miners_io.png',
    links: [{ label: 'YouTube demo', url: 'https://www.youtube.com/watch?v=DrKKEIgzWFM&feature=youtu.be' }],
  },
  {
    title: 'Ray Flex: In A Murky Space', meta: 'Educational · Reflection & Refraction (Research)', image: IMG + 'ray_flex.png',
    links: [{ label: 'itch.io', url: 'https://osamasarfraz.itch.io/ray-flex-in-a-murky-space' }],
  },
  {
    title: 'Defend The Dice', meta: '3D Puzzle · Dice-based strategy', image: IMG + 'defend_the_dice.png',
